...
{
    return (new \com\eunionz\core\Kernel())->loadComponent($class, $single);
}
...
{
    return (new \com\eunionz\core\Kernel())->loadService($class, $single);
}
...
{
    return (new \com\eunionz\core\Kernel())->loadPlugin($class, $single);
}
...
{
    return (new \com\eunionz\core\Kernel())->loadModel($class, $single);
}
...
{
    return (new \com\eunionz\core\Kernel())->loadCore('log')->log($level, $message, $filename);
}
...
{
    return \com\eunionz\core\Kernel::getConfig($namespace, $key);
}

/**
 * 获取当前进程上下文对像
 * @return \com\eunionz\core\Context
 */
function ctx(): ?\com\eunionz\core\Context
{
    return \com\eunionz\core\Kernel::getContext();
}
...
{
    return \com\eunionz\core\Kernel::console($msg, $level);
}
...
{
    return \com\eunionz\core\Kernel::consoleln($msg, $level);
}

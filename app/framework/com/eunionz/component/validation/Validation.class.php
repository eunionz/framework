...
namespace com\eunionz\component\validation;

defined('APP_IN') or exit('Access Denied');
class Validation extends \com\eunionz\core\Component {
    ...
    public function get_validate_rules($resource){
        ...
        try{
            ...
            throw new \com\eunionz\exception\UploadException($this->getLang('error_validation_title'),$this->getLang('error_validation_exception',array($err->getMessage())));
            //没有验证规则
            return $validate_clients;
        }
    }

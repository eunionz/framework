...
//                    }
                    ...
                    try {
                        ...
                        if (!$rs) {
                            throw new \com\eunionz\exception\DBException($this->getLang('error_db_title'), $this->getLang('error_db_pdo', array($config['HOST'] . ':' . $config['PORT'], ' connect fail.')));
                        }
                    } catch (\PDOException $e) {
                        throw new \com\eunionz\exception\DBException($this->getLang('error_db_title'), $this->getLang('error_db_pdo', array($e->getMessage())));
                    }
...
//                        }
    ...
    public function exec($sql, $values = null)
    {
        ...
        if (false === $result) {
            throw new \com\eunionz\exception\DBException($this->getLang('error_db_title'), $this->getLang('error_db_pdo', array($this->get_last_error($pdo))));
        }

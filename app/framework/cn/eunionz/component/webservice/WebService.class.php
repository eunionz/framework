...
namespace cn\eunionz\component\webservice;

defined('APP_IN') or exit('Access Denied');
class WebService extends \cn\eunionz\core\Component {
...
<definitions'.$this->createdefinitions().'
    ...
    private function parseClass($operation)
    {
        ...
        if (empty($functions))
        {
            throw new \cn\eunionz\exception\WebServiceException($this->getLang('error_webservice_title'),$this->getLang('error_webservice_operation',array($operation)));
        }
    ...
    public function create($wsdlURI, $className)
    {
        if (!class_exists('SoapServer'))
            throw new \cn\eunionz\exception\WebServiceException($this->getLang('error_webservice_title'),$this->getLang('error_webservice_soap'));

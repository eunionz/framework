...
namespace cn\eunionz\component\image;
 ...
 * 
 */
class Image extends \cn\eunionz\core\Component
{
	// 源图像路径
	private $_src;
	...
	private function createImgFromSourceFile($src)
	{
		...
		{
            throw new \cn\eunionz\exception\ImageException($this->getLang('error_image_title'),$this->getLang('error_image_read',array($src)));
		}
		elseif (!function_exists('imagecreatefromgif') || !function_exists('imagecreatefromjpeg') || !function_exists('imagecreatefrompng'))
		{
            throw new \cn\eunionz\exception\ImageException($this->getLang('error_image_title'),$this->getLang('error_image_gd'));
		}
	...
	public function sharp($degree)
	{
		if (!is_resource($this->_srcIm))
		{
            throw new \cn\eunionz\exception\ImageException($this->getLang('error_image_title'),$this->getLang('error_image_load'));
		}

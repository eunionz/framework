...
use cn\eunionz\component\grpc\VirtualClient;
...
class Output extends Kernel
{
    ...
    public function __construct()
    {
        ...
        $this->output_compress = self::getConfig('app', 'APP_OUTPUT_COMPRESS');
    }
     ...
     * @param bool $compress
     */
    public function render(string $str = '', bool $compress = true): void
    {
        // set header
     ...
     */
    public function setHeaderStatus(int $code = 200, string $text = ''): void
    {
        $stati = array(
            200 => 'OK',
            201 => 'Created',
     ...
     */
    public function setHeaderCharset(string $charset): void
    {
     ...
     */
    public function setHeaderType(string $mime_type): void
    {
        $mimes = array(

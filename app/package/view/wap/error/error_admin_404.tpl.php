@extends('layout.error_admin')@section('content')
<!--
...
<div class="error_wen text-center">
    @getLang('app_404_error_content') <br/> global
    @getLang('error_exception_message'){{$Exception['message']}}<br/>
    <a href="/admin/home/index.html">>>@getLang('app_404_error_title',#28; 2+4 #29;,'web')</a>
</div>
@endsection

...
class Weixinadv extends \com\eunionz\core\Plugin
{
    ...
    public function init($appid,$appsecret)
    {
        ...
        if(!isset($_SESSION['weixin_lasttime']) || empty($_SESSION['weixin_lasttime'])){
            $weixin_expired=true;
        }else{
            $this->access_token = $_SESSION['weixin_access_token'];
            $this->lasttime = $_SESSION['weixin_lasttime'];
        ...
        if($weixin_expired){
            ...
            $_SESSION['weixin_lasttime']=$this->lasttime;
            $_SESSION['weixin_access_token']=$this->access_token;
        }

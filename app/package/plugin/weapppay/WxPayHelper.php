...
class WxPayHelper
{
    ...
    var $APPID;  //微信公众号 appid
    var $PARTNER_ID;  //微信公众号 商户号id
    var $APPKEY;  //微信公众号 paysign key
    var $SIGNTYPE='sha1'; //签名方法  method
    var $PARTNERKEY='';  //通用加密签 通加密串
    var $APPSERCERT=''; //通用加密签 通加密串

    public function init($appid,$appkey,$signtype,$partnerkey,$appsercert,$partner_id){

...
/**
 * EUnionZ PHP Framework Jpush Plugin class
 * Created by PhpStorm.
...
class Jpush extends \com\eunionz\core\Plugin
{
     ...
     * @param string $param
     */
    private $_appkeys = 'c5493c996577ffc7d1295af2';
    private $_masterSecret = '705d61118489164b4efcfa85';
     ...
     */
    function send($sendno = 15,$receiver_type = 4, $receiver_value = "", $msg_type = 1, $msg_content = "", $platform = 'android')
    {
...
//$data = $this->P('jpush')->send(16,4, "", 1, $msg_content, $platform);
//print_r($data);
//
//
//exit;

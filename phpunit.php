...
class AutoPhpUnitTest
{
    ...
    const PHP_CLI_EXE_PATH = 'D:/phpStudy/PHPTutorial/php/php-7.2.1-nts/php.exe';
    const PHP_PHPUNIT_EXE_PATHE_PATH = 'D:/swoole/eunionz_ctx/framework/vendor/phpunit/phpunit/phpunit';
    const PHP_PHPUNIT_CLASS_PATH = 'D:/swoole/eunionz_ctx/framework/app/package/tests';
    const PHP_PHPUNIT_CLASS_PREFIX_PATH = 'D:/swoole/eunionz_ctx/framework/app/';
    const PHP_PHPUNIT_OUTPUT_PATH = 'D:/swoole/eunionz_ctx/framework/storage/runtime/phpunit';

    const PHP_PHPUNIT_CLASS_EXCLUDE_FILENAMES = ['D:/swoole/eunionz_ctx/framework/app/package/tests/TestBase.php'];
